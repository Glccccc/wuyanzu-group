...
# Введите ключ и значение через пробел: 123 арбуз
# Введите ключ и значение через пробел: 124 груша
# Введите ключ и значение через пробел: 125 слива
# Введите ключ и значение через пробел:
# Введите значение из словаря: яблоко
# !   v a l u e   e r r o r   !
