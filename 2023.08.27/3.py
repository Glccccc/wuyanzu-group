...
cv1 = CVBuilder('Рафикова Лилия Маратовна', 33, 'Web-разработчик', email='rlm@mail.ru')\
    .add_education('ТОР-академия', 'Python', 2023)\
    .add_contact('telegram', '@liliya')\
    .add_contact('mobile', '987654321')\
    .add_project('Benefits of python','3.1.png')\
    .add_project('Сайт для туристического оператора','3.2.png')\
    .build()
